      ...
      {!isStoreReviewMode && (
        ...
        >
          ...
          <View style={styles.menuBtnContent}>
            ...
            <Text style={styles.menuBtnDesc}>クラブ内でリアルタイム対戦</Text>
          </View>
          <Text style={styles.menuArrow}>›</Text>
        </TouchableOpacity>
      )}
      ...
      <SafeAreaView style={styles.safeArea}>
        ...
        {isLandscape ? (
          ...
          <View style={styles.landscapeRow}>
            <View style={styles.titleAreaLandscape}>
              <Text style={styles.titleMain}>麻雀</Text>
              <Text style={styles.titleSub}>
                {isStoreReviewMode ? "アミューズメント麻雀" : "クローズド プラットフォーム"}
              </Text>
            </View>
            <View style={styles.menuAreaLandscape}>{menuButtons}</View>
          </View>
        ) : (
          /* ===== Portrait: stacked ===== */
          <ScrollView
            ...
            bounces={false}
          >
            <View style={styles.titleAreaPortrait}>
              <Text style={styles.titleMain}>麻雀</Text>
              <Text style={styles.titleSub}>
                {isStoreReviewMode ? "アミューズメント麻雀" : "クローズド プラットフォーム"}
              </Text>
            </View>
            <View style={styles.menuAreaPortrait}>{menuButtons}</View>
          </ScrollView>
        )}
